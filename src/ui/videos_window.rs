...
pub fn main() {
    ...
    table.set_on_submit(|siv: &mut Cursive, row: usize, index: usize| {
        let value = siv
            .call_on_name("videos", move |table: &mut TableView<Foo, BasicColumn>| {
        ...
        siv.add_layer(
            Dialog::around(TextView::new(value))
                ...
                .button("Close", move |s| {
                    s.call_on_name("videos", |table: &mut TableView<Foo, BasicColumn>| {
    ...
    siv.add_layer(Dialog::around(table.with_name("videos").min_size((50, 20))).title("Videos View"));
